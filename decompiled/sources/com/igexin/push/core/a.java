...
public class a {
    public static final String a = Environment.getExternalStorageDirectory() + "/Sdk/ImgCache/";
    public static final String b = Environment.getExternalStorageDirectory() + "/Sdk/WebCache/";
