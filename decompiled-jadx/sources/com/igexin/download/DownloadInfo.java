...
public class DownloadInfo implements Serializable, Cloneable {
    ...
    public DownloadInfo(int i, String str, boolean z, String str2, String str3, String str4, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, long j2, String str5, String str6, String str7, String str8, int i9, int i10, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, long j3, int i11, boolean z2) {
        ...
        this.mETag = str9;
        this.mFuzz = h.a.nextInt(PipawSDK.PAY_SUCCESS);
        this.mData1 = str10;
        this.mData2 = str11;
        this.mData3 = str12;
        this.mData4 = str13;
    ...
    public void refreshSpeed() {
        ...
        if (this.mCurrentBytes != this.mLastBytes) {
            if (this.a != 0) {
                this.mDownSpeed = ((long) (Math.max(0, this.mCurrentBytes - this.mLastBytes) * PipawSDK.PAY_CANCEL)) / jCurrentTimeMillis;
            } else {
                this.mDownSpeed = 0L;
            }
        ...
        if (jCurrentTimeMillis > 1500) {
            this.mDownSpeed = 0L;
        } else if (jCurrentTimeMillis > 500) {
            this.mDownSpeed >>= 1;
        }
    }

    public long restartTime() {
        return this.mRetryAfter > 0 ? this.mLastMod + ((long) this.mRetryAfter) : this.mLastMod + ((long) ((this.mFuzz + PipawSDK.PAY_CANCEL) * 30 * (1 << (this.mNumFailed - 1))));
    }
}
