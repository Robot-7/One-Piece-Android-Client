...
public class d extends e {
    ...
    public byte[] d() {
        ...
        try {
            ...
            byte[] bytes2 = !StatConstants.MTA_COOPERATION_TAG.equals(this.e) ? this.b == 192 ? (byte[]) this.e : ((String) this.e).getBytes(this.h) : null;
            ...
            try {
                ...
                int iC = iB + com.igexin.a.a.b.g.c(this.b | a(this.h), bArr, iB);
                int iA = iC + com.igexin.a.a.b.g.a(this.c, bArr, iC);
                int iC2 = iA + com.igexin.a.a.b.g.c(bytes.length, bArr, iA);
                int iA2 = iC2 + com.igexin.a.a.b.g.a(bytes, 0, bArr, iC2, bytes.length);
                int iA3 = iA2 + com.igexin.a.a.b.g.a(bArrA, 0, bArr, iA2, bArrA.length);
                if (length > 0) {
                    iA3 += com.igexin.a.a.b.g.a(bytes2, 0, bArr, iA3, length);
                }
                int iA4 = iA3 + com.igexin.a.a.b.g.a(bArrA2, 0, bArr, iA3, bArrA2.length);
                if (length2 > 0) {
                    iA4 += com.igexin.a.a.b.g.a(bArr2, 0, bArr, iA4, length2);
                }
                int iC3 = iA4 + com.igexin.a.a.b.g.c(bytes3.length, bArr, iA4);
                int iA5 = iC3 + com.igexin.a.a.b.g.a(bytes3, 0, bArr, iC3, bytes3.length);
            } catch (Exception e) {
            }
        } catch (Exception e2) {
            bArr = null;
