...
public class f {
    ...
    static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i7 = 0; i7 < bArr.length; i7++) {
            i6 = (i6 + 1) & MotionEventCompat.ACTION_MASK;
            i5 = (i5 + iArr[i6]) & MotionEventCompat.ACTION_MASK;
            int i8 = iArr[i6];
            iArr[i6] = iArr[i5];
            iArr[i5] = i8;
            bArr3[i7] = (byte) (iArr[(iArr[i6] + iArr[i5]) & MotionEventCompat.ACTION_MASK] ^ bArr[i7]);
        }
        return bArr3;
    }
