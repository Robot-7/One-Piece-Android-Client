...
final class e {
    ...
    final void a(JSONObject jSONObject, Thread thread) throws JSONException {
        if (thread == null) {
            if (this.cA != null) {
            ...
            if (com.tencent.wxop.stat.h.r(this.cB).W()) {
            ...
            JSONArray jSONArrayY = r.Y(this.cB);
            if (jSONArrayY != null && jSONArrayY.length() > 0) {
                r.a(jSONObject, "wflist", jSONArrayY.toString());
            }
            r.a(jSONObject, "sen", this.cC);
        } else {
            r.a(jSONObject, "thn", thread.getName());
            r.a(jSONObject, "qq", com.tencent.wxop.stat.c.f(this.cB));
            r.a(jSONObject, "cui", com.tencent.wxop.stat.c.g(this.cB));
            ...
            if (u.s(this.cB).t(this.cB) != null) {
                jSONObject.put(MidEntity.TAG_IMEI, u.s(this.cB).t(this.cB).b());
            }
            r.a(jSONObject, MidEntity.TAG_MID, com.tencent.wxop.stat.c.h(this.cB));
        }
