...
public class b {
    ...
    public static f a(String str) throws IOException {
        ...
        HttpResponse httpResponseExecute = a.execute(httpGet);
        int statusCode = httpResponseExecute.getStatusLine().getStatusCode();
        String strA = a(httpResponseExecute);
        Util.logInfo("http get response code:" + statusCode + " ,data:" + strA);
        return new f(statusCode, strA);
    }
    ...
    public static f a(String str, String str2) throws IOException {
        ...
        httpPost.setEntity(new ByteArrayEntity(com.tencent.mid.util.h.a(bytes)));
        HttpResponse httpResponseExecute = a.execute(httpPost);
        ...
        if (contentLength <= 0) {
            ...
            strA = a(httpResponseExecute);
        }
        Util.logInfo("recv response status code:" + statusCode + ", content :" + strA);
        return new f(statusCode, strA);
    }
    ...
    private static String a(HttpResponse httpResponse) throws IOException {
        ...
        byte[] bArrB = new byte[(int) httpResponse.getEntity().getContentLength()];
        ...
        if (firstHeader != null) {
            if (firstHeader.getValue().equalsIgnoreCase("gzip,rc4")) {
                bArrB = com.tencent.mid.util.h.b(Util.deocdeGZipContent(bArrB));
            } else if (firstHeader.getValue().equalsIgnoreCase("rc4,gzip")) {
                bArrB = Util.deocdeGZipContent(com.tencent.mid.util.h.b(bArrB));
            } else if (firstHeader.getValue().equalsIgnoreCase("gzip")) {
                bArrB = Util.deocdeGZipContent(bArrB);
            } else if (firstHeader.getValue().equalsIgnoreCase("rc4")) {
                bArrB = com.tencent.mid.util.h.b(bArrB);
            }
        }
