...
class MMSharedPreferences implements SharedPreferences {
    ...
    private static class REditor implements SharedPreferences.Editor {
        ...
        public boolean commit() {
            ...
            while (it.hasNext()) {
                this.cr.delete(a.b.CONTENT_URI, "key = ?", new String[]{it.next()});
            }
            for (Map.Entry<String, Object> entry : this.values.entrySet()) {
                ...
                if (z) {
                    this.cr.update(a.b.CONTENT_URI, contentValues, "key = ?", new String[]{entry.getKey()});
                }
            }
            return true;
        }
    ...
    private Object getValue(String str) {
        try {
            Cursor cursorQuery = this.cr.query(a.b.CONTENT_URI, this.columns, "key = ?", new String[]{str}, null);
            if (cursorQuery == null) {
                return null;
            }
            Object objA = cursorQuery.moveToFirst() ? a.C0005a.a(cursorQuery.getInt(cursorQuery.getColumnIndex("type")), cursorQuery.getString(cursorQuery.getColumnIndex("value"))) : null;
            cursorQuery.close();
            return objA;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Map<String, ?> getAll() {
        try {
            Cursor cursorQuery = this.cr.query(a.b.CONTENT_URI, this.columns, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
            ...
            while (cursorQuery.moveToNext()) {
                this.values.put(cursorQuery.getString(columnIndex), a.C0005a.a(cursorQuery.getInt(columnIndex2), cursorQuery.getString(columnIndex3)));
            }
            cursorQuery.close();
            return this.values;
        } catch (Exception e) {
