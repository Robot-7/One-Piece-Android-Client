...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", Consts.BITYPE_UPDATE, Consts.BITYPE_RECOMMEND, "4", "5", "6", "7", "8", "9", "10"};
    ...
    public static int outputInt(int value, char[] buffer, int offset) {
        ...
        if (value < MILLION) {
            if (value < 1000) {
                ...
                int thousands = value / PipawSDK.PAY_CANCEL;
                offset3 = outputFullTriplet(value - (thousands * PipawSDK.PAY_CANCEL), buffer, outputLeadingTriplet(thousands, buffer, offset));
            }
            return offset3;
        }
        ...
        int newValue = value / PipawSDK.PAY_CANCEL;
        int ones = value - (newValue * PipawSDK.PAY_CANCEL);
        int newValue2 = newValue / PipawSDK.PAY_CANCEL;
        int thousands2 = newValue - (newValue2 * PipawSDK.PAY_CANCEL);
        if (hasBillions) {
    ...
    public static int outputLong(long value, char[] buffer, int offset) {
        ...
        while (ivalue >= 1000) {
            ptr -= 3;
            int newValue2 = ivalue / PipawSDK.PAY_CANCEL;
            int triplet2 = ivalue - (newValue2 * PipawSDK.PAY_CANCEL);
