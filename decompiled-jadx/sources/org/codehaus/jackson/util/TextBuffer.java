...
public final class TextBuffer {
    ...
    public String contentsAsString() {
        if (this._resultString == null) {
            if (this._resultArray != null) {
                ...
                if (this._inputLen < 1) {
                    this._resultString = StatConstants.MTA_COOPERATION_TAG;
                ...
                if (segLen == 0) {
                    this._resultString = currLen == 0 ? StatConstants.MTA_COOPERATION_TAG : new String(this._currentSegment, 0, currLen);
                } else {
    ...
    public char[] finishCurrentSegment() {
        ...
        int newLen = Math.min((oldLen >> 1) + oldLen, 262144);
    ...
    public char[] expandCurrentSegment() {
        char[] curr = this._currentSegment;
        int len = curr.length;
        int newLen = len == 262144 ? 262145 : Math.min(262144, (len >> 1) + len);
    ...
    private void expand(int minNewSegmentSize) {
        ...
        char[] curr2 = _charArray(Math.min(262144, oldLen + sizeAddition));
        this._currentSize = 0;
        this._currentSegment = curr2;
    }
