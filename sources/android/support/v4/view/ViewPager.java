    ...
    void populate(int newCurrentItem) {
        ...
        if (getWindowToken() != null) {
            ...
            if (curItem != null) {
                ...
                float leftWidthNeeded = (2.0f - curItem.widthFactor) + (getPaddingLeft() / getClientWidth());
                ...
                if (extraWidthRight < 2.0f) {
                    ...
                    float rightWidthNeeded = (getPaddingRight() / getClientWidth()) + 2.0f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8 && (lp2 = (LayoutParams) child.getLayoutParams()) != null && lp2.isDecor) {
                ...
                int vgrav = lp2.gravity & Opcodes.IREM;
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(PipawSDK.PAY_CANCEL, this.mMaximumVelocity);
