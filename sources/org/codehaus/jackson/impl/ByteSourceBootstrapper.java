...
public final class ByteSourceBootstrapper {
        ...
        if (!foundEncoding) {
            ...
            switch (this._bytesPerChar) {
                case 1:
                    ...
                    break;
                case 2:
                    enc = !this._bigEndian ? JsonEncoding.UTF16_LE : JsonEncoding.UTF16_BE;
                    break;
                case 3:
                default:
                    throw new RuntimeException("Internal error");
                case 4:
                    enc = !this._bigEndian ? JsonEncoding.UTF32_LE : JsonEncoding.UTF32_BE;
                    break;
            }
        }
    ...
    public JsonParser constructParser(int features, ObjectCodec codec, BytesToNameCanonicalizer rootByteSymbols, CharsToNameCanonicalizer rootCharSymbols) throws IOException {
    ...
    */
    ...
    private boolean checkUTF16(int i16) {
        if ((65280 & i16) == 0) {
            ...
            if ((i16 & MotionEventCompat.ACTION_MASK) != 0) {
                return false;
            }
            this._bigEndian = false;
        }
