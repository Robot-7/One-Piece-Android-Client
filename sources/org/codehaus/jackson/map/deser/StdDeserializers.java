...
class StdDeserializers {
    ...
    private StdDeserializers() {
        ...
        org.codehaus.jackson.map.deser.std.StdDeserializer<?> strDeser = new StringDeserializer();
        ...
        for (org.codehaus.jackson.map.deser.std.StdDeserializer<?> deser : org.codehaus.jackson.map.deser.std.FromStringDeserializer.all()) {
            add(deser);
        }
    ...
    private void add(org.codehaus.jackson.map.deser.std.StdDeserializer<?> stdDeser) {
        add(stdDeser, stdDeser.getValueClass());
    }

    private void add(org.codehaus.jackson.map.deser.std.StdDeserializer<?> stdDeser, Class<?> valueClass) {
